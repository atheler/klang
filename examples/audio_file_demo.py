"""Audio file demo."""
from klang.audio.effects import Delay, Tremolo, Filter, Transformer, StereoDelay, Bitcrusher, Subsampler
...
if __name__ == '__main__':
    # Init blocks
    audioFile = AudioFile(FILEPATH, playbackSpeed=.75, loop=True)
